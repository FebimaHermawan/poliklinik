                  ...
                  <div class="box box-primary">
                        ...
                        <form method="post">
                              ...
                              <div class="box-footer">
                                    <input type="submit" name="btn-edit-karyawan" class="btn btn-primary btn-flat" value="Edit">
...
<?php
	if (isset($POST["btn-edit-karyawan"])) {
		extract($POST);
            if ($nama != "") {
                if ($username != "") {
                      if ($password != "") {
                              ...
                              while ($valAd = $cekAd->fetch()) {
                                  if ($valAd["username"] == $username) {
                                    ...
                                    $db->validationInput("?hal=user/home&opt=ed&id=$getid&type=karyawan&name=Karyawan", "Username");
                                  }
                              }
                      }
                      else{
                              $db->errorInput("?hal=user/home&opt=ed&id=$getid&type=karyawan&name=Karyawan", "Password");
                      }
                  }else{
                         $db->errorInput("?hal=user/home&opt=ed&id=$getid&type=karyawan&name=Karyawan", "Username");
                  }
            }
            else{
                  $db->errorInput("?hal=user/home&opt=ed&id=$getid&type=karyawan&name=Karyawan", "nama");
            }
	}
