<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header">
			<h3 class="box-title">Data Obat Terjual</h3>
		</div>
		<div class="box-body">
			<div id="example_wrapper1" class="dataTables_wrapper form-inline dt-bootstrap">
				<div class="row">
					<div class="col-md-12" style="margin-bottom: 25px;">
						...
						<a href="index.php?hal=pengecekan/penjualan-obat/home&act=print">
						...
						<?php
							if (isset($POST["print"])) {
								extract($POST);
									if ($sd != "") {
										if ($fd != "") {
											$db->redirect("index.php?hal=pengecekan/penjualan-obat/home&act=print&sd=$sd&fd=$fd");
										}
										else{
											$db->errorInput("?hal=pengecekan/penjualan-obat/home", "tanggal selesai print");
										}
									}
									else{
										$db->errorInput("?hal=pengecekan/penjualan-obat/home", "tanggal mulai print");
									}
							}
						?>
					</div>
					<div class="col-sm-12">
						<table id="data-table" class="table table-stripped table-bordered">
							...
							<tbody>
								<?php
									$no = 0;
									$getob = $db->getResult("select * from activity_obat where status = '2'");
